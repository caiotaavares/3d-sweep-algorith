...
void Canvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->pathChanged((*reinterpret_cast< std::add_pointer_t<QList<QPointF>>>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Canvas::*)(const QVector<QPointF> & );
            if (_t _q_method = &Canvas::pathChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Canvas::pathChanged(const QVector<QPointF> & _t1)
{
